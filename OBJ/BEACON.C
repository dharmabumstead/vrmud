 ...
 *    07/10/93  Slider  Changed peek to use transfer player, so user can   *
...
"------------------------------------------------------------------------------\n");
  say(this_player()->query_name()+" gazes into a Slider's beacon scroll.\n");
                currloc = environment(this_player());

                transfer(this_player(), destobj);
